...
### ✅ Adım 6 — Final narrative notebook (yerel kod) (2026-06-06)
...
- **Kaggle teyit (tam veri):** Holdout MAE 3.1725 / RMSE 8.4893 / R² 0.9368, n_test 3.245.031. Feature importance + yorum + grafikler geldi.
- **REPRODUCIBILITY kanıtı:** İki bağımsız Kaggle eğitimi neredeyse bire bir aynı (MAE 3.1733→3.1725, R² 0.9369→0.9368, CV 3.177→3.1765). Fark 4. hane = GPU floating-point non-determinism, ihmal edilebilir → pipeline stabil/tekrarlanabilir. Repodaki model geçerli, yeniden commit gerekmez.
